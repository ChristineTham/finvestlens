...
| Find's account picker is a flat list of 559 | The Account criterion lists every account in one unsearchable menu — type-to-select works only if you know the full colon path. Needs a filter field. | P7 |
